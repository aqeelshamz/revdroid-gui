...
export default function Page() {
    ...
    const [selectedTab, setSelectedTab] = useState<keyof typeof tabsComponents>("run-script");
    ...
    return <div className="flex flex-col w-full h-full">
        <div className="flex items-center justify-between p-3">
            ...
            <div className="flex items-center">
                ...
                <a target="_blank" className="flex ml-7 items-center link link-hover" href="https://github.com/aqeelshamz/revdroid-gui"><FaGithub className="mr-2" /> GitHub</a>
            </div>
        </div>
