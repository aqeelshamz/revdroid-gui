        ...
        <div className="p-5 flex-1 flex flex-col min-h-0">
          {selectedDevice === "" ? (
            ...
            <div className="flex flex-col w-full h-full">
              ...
              <div className="flex w-fit items-center justify-between mt-4">
                <input type="text" placeholder="Search" className="mr-4 input input-bordered w-64" value={search} onChange={(x) => setSearch(x.target.value)} />
